...
public final class MessageNanoPrinter {
                    ...
                    if (name.startsWith("set")) {
                        ...
                        try {
                            if (((Boolean) clazz.getMethod("has" + subfieldName, new Class[0]).invoke(object, new Object[0])).booleanValue()) {
                                try {
                                    print(subfieldName, clazz.getMethod(Endpoints.ENDPOINT_GET + subfieldName, new Class[0]).invoke(object, new Object[0]), indentBuf, buf);
    ...
    private static void appendQuotedBytes(byte[] bytes, StringBuffer builder) {
        ...
        for (byte b : bytes) {
            ...
            } else if (ch < 32 || ch >= LogSource.TAILORMADE) {
