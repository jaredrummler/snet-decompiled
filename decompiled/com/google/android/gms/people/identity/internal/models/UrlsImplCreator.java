...
public class UrlsImplCreator implements Creator<UrlsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public UrlsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new UrlsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public UrlsImpl[] newArray(int size) {
        return new UrlsImpl[size];
    }

    static void writeToParcel(UrlsImpl obj, Parcel parcel, int flags) {
