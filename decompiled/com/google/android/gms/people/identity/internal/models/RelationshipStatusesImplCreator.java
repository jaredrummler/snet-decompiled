...
public class RelationshipStatusesImplCreator implements Creator<RelationshipStatusesImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public RelationshipStatusesImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new RelationshipStatusesImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mFormattedValue, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public RelationshipStatusesImpl[] newArray(int size) {
        return new RelationshipStatusesImpl[size];
    }

    static void writeToParcel(RelationshipStatusesImpl obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(3))) {
            SafeParcelWriter.writeString(parcel, 3, obj.mFormattedValue, true);
        }
