...
public class DefaultPersonImpl_EventsCreator implements Creator<Events> {
    ...
    public Events createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Events(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mDate, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mType);
        }
    ...
    static void writeToParcel(Events obj, Parcel parcel, int flags) {
