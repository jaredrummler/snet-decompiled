...
public class AddressesImplCreator implements Creator<AddressesImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public AddressesImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new AddressesImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mCity, _local_safe_0a1b_mCountry, _local_safe_0a1b_mCountryCode, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mPoBox, _local_safe_0a1b_mPostalCode, _local_safe_0a1b_mRegion, _local_safe_0a1b_mStreetAddress, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public AddressesImpl[] newArray(int size) {
        return new AddressesImpl[size];
    }

    static void writeToParcel(AddressesImpl obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(3))) {
            SafeParcelWriter.writeString(parcel, 3, obj.mCity, true);
        }
        if (__setFields.contains(Integer.valueOf(4))) {
            SafeParcelWriter.writeString(parcel, 4, obj.mCountry, true);
        }
        if (__setFields.contains(Integer.valueOf(5))) {
            SafeParcelWriter.writeString(parcel, 5, obj.mCountryCode, true);
        }
        if (__setFields.contains(Integer.valueOf(6))) {
            SafeParcelWriter.writeString(parcel, 6, obj.mFormattedType, true);
        }
