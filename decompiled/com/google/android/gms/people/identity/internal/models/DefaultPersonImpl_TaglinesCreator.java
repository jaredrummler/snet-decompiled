...
public class DefaultPersonImpl_TaglinesCreator implements Creator<Taglines> {
    public static final int CONTENT_DESCRIPTION = 0;

    public Taglines createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Taglines(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public Taglines[] newArray(int size) {
        return new Taglines[size];
    }

    static void writeToParcel(Taglines obj, Parcel parcel, int flags) {
