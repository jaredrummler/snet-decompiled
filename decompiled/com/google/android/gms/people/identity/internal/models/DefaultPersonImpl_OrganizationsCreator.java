...
public class DefaultPersonImpl_OrganizationsCreator implements Creator<Organizations> {
    ...
    public Organizations createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Organizations(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mCurrent, _local_safe_0a1b_mDepartment, _local_safe_0a1b_mDescription, _local_safe_0a1b_mDomain, _local_safe_0a1b_mEndDate, _local_safe_0a1b_mLocation, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mName, _local_safe_0a1b_mPhoneticName, _local_safe_0a1b_mStartDate, _local_safe_0a1b_mSymbol, _local_safe_0a1b_mTitle, _local_safe_0a1b_mType);
        }
    ...
    static void writeToParcel(Organizations obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(3))) {
            SafeParcelWriter.writeString(parcel, 3, obj.mDepartment, true);
        }
        if (__setFields.contains(Integer.valueOf(4))) {
            SafeParcelWriter.writeString(parcel, 4, obj.mDescription, true);
        }
        if (__setFields.contains(Integer.valueOf(5))) {
            SafeParcelWriter.writeString(parcel, 5, obj.mDomain, true);
        }
        if (__setFields.contains(Integer.valueOf(6))) {
            SafeParcelWriter.writeString(parcel, 6, obj.mEndDate, true);
        }
        if (__setFields.contains(Integer.valueOf(7))) {
            SafeParcelWriter.writeString(parcel, 7, obj.mLocation, true);
        }
