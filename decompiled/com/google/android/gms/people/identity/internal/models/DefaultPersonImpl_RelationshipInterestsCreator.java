...
public class DefaultPersonImpl_RelationshipInterestsCreator implements Creator<RelationshipInterests> {
    public static final int CONTENT_DESCRIPTION = 0;

    public RelationshipInterests createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new RelationshipInterests(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public RelationshipInterests[] newArray(int size) {
        return new RelationshipInterests[size];
    }

    static void writeToParcel(RelationshipInterests obj, Parcel parcel, int flags) {
