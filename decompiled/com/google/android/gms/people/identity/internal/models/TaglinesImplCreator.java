...
public class TaglinesImplCreator implements Creator<TaglinesImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public TaglinesImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new TaglinesImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public TaglinesImpl[] newArray(int size) {
        return new TaglinesImpl[size];
    }

    static void writeToParcel(TaglinesImpl obj, Parcel parcel, int flags) {
