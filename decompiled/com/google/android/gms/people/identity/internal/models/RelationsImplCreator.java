...
public class RelationsImplCreator implements Creator<RelationsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public RelationsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new RelationsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public RelationsImpl[] newArray(int size) {
        return new RelationsImpl[size];
    }

    static void writeToParcel(RelationsImpl obj, Parcel parcel, int flags) {
