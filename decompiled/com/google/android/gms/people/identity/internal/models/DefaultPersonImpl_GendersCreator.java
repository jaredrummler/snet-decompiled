...
public class DefaultPersonImpl_GendersCreator implements Creator<Genders> {
    public static final int CONTENT_DESCRIPTION = 0;

    public Genders createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Genders(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mFormattedValue, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public Genders[] newArray(int size) {
        return new Genders[size];
    }

    static void writeToParcel(Genders obj, Parcel parcel, int flags) {
