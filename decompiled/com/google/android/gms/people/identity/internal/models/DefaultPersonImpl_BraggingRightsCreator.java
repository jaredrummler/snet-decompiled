...
public class DefaultPersonImpl_BraggingRightsCreator implements Creator<BraggingRights> {
    public static final int CONTENT_DESCRIPTION = 0;

    public BraggingRights createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new BraggingRights(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public BraggingRights[] newArray(int size) {
        return new BraggingRights[size];
    }

    static void writeToParcel(BraggingRights obj, Parcel parcel, int flags) {
