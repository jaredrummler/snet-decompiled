...
public class BraggingRightsImplCreator implements Creator<BraggingRightsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public BraggingRightsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new BraggingRightsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public BraggingRightsImpl[] newArray(int size) {
        return new BraggingRightsImpl[size];
    }

    static void writeToParcel(BraggingRightsImpl obj, Parcel parcel, int flags) {
