...
public class DefaultPersonImpl_UrlsCreator implements Creator<Urls> {
    ...
    public Urls createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Urls(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
    ...
    static void writeToParcel(Urls obj, Parcel parcel, int flags) {
