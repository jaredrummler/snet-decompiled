...
public class DefaultPersonImpl_RelationshipStatusesCreator implements Creator<RelationshipStatuses> {
    public static final int CONTENT_DESCRIPTION = 0;

    public RelationshipStatuses createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new RelationshipStatuses(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mFormattedValue, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public RelationshipStatuses[] newArray(int size) {
        return new RelationshipStatuses[size];
    }

    static void writeToParcel(RelationshipStatuses obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(2))) {
            SafeParcelWriter.writeString(parcel, 2, obj.mFormattedValue, true);
        }
