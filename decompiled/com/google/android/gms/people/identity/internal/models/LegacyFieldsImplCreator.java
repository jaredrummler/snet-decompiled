...
public class LegacyFieldsImplCreator implements Creator<LegacyFieldsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public LegacyFieldsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new LegacyFieldsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMobileOwnerId);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public LegacyFieldsImpl[] newArray(int size) {
        return new LegacyFieldsImpl[size];
    }

    static void writeToParcel(LegacyFieldsImpl obj, Parcel parcel, int flags) {
