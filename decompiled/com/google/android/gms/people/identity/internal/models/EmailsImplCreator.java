...
public class EmailsImplCreator implements Creator<EmailsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public EmailsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new EmailsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mType, _local_safe_0a1b_mValue, _local_safe_0a1b_mTimesUsed);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public EmailsImpl[] newArray(int size) {
        return new EmailsImpl[size];
    }

    static void writeToParcel(EmailsImpl obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(6))) {
            SafeParcelWriter.writeInt(parcel, 6, obj.mTimesUsed);
        }
