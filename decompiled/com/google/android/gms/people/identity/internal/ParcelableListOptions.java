...
@Class(creator = "ParcelableListOptionsCreator")
@VisibleForTesting
public final class ParcelableListOptions implements SafeParcelable {
    public static final ParcelableListOptionsCreator CREATOR;
    ...
    static {
        CREATOR = new ParcelableListOptionsCreator();
    }

    @Constructor
    ParcelableListOptions(@Param(id = 1000) int versionCode, @Param(id = 1) boolean useOfflineDatabase, @Param(id = 2) boolean useWebData, @Param(id = 4) boolean useCp2, @Param(id = 3) String endpoint, @Param(id = 5) Bundle endpointArguments) {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ParcelableListOptionsCreator.writeToParcel(this, out, flags);
    }

    public String toString() {
        return Objects.toStringHelper(this).add("useOfflineDatabase", Boolean.valueOf(this.mUseOfflineDatabase)).add("useWebData", Boolean.valueOf(this.mUseWebData)).add("useCP2", Boolean.valueOf(this.mUseCp2)).add("endpoint", this.mEndpoint).toString();
    }
}
