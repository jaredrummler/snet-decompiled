...
public class EventsImplCreator implements Creator<EventsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public EventsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new EventsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mType, _local_safe_0a1b_mDate);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public EventsImpl[] newArray(int size) {
        return new EventsImpl[size];
    }

    static void writeToParcel(EventsImpl obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(5))) {
            SafeParcelWriter.writeString(parcel, 5, obj.mDate, true);
        }
