...
public class ParcelableListOptionsCreator implements Creator<ParcelableListOptions> {
    ...
    public ParcelableListOptions createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new ParcelableListOptions(_local_safe_0a1b_mVersionCode, _local_safe_0a1b_mUseOfflineDatabase, _local_safe_0a1b_mUseWebData, _local_safe_0a1b_mUseCp2, _local_safe_0a1b_mEndpoint, _local_safe_0a1b_mEndpointArguments);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public ParcelableListOptions[] newArray(int size) {
        return new ParcelableListOptions[size];
    }

    static void writeToParcel(ParcelableListOptions obj, Parcel parcel, int flags) {
