...
public class DefaultPersonImpl_AboutsCreator implements Creator<Abouts> {
    public static final int CONTENT_DESCRIPTION = 0;

    public Abouts createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Abouts(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
    ...
    static void writeToParcel(Abouts obj, Parcel parcel, int flags) {
