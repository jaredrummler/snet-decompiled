...
public class DefaultPersonImpl_NamesCreator implements Creator<Names> {
    ...
    public Names createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Names(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mDisplayName, _local_safe_0a1b_mFamilyName, _local_safe_0a1b_mFormatted, _local_safe_0a1b_mGivenName, _local_safe_0a1b_mHonorificPrefix, _local_safe_0a1b_mHonorificSuffix, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mMiddleName, _local_safe_0a1b_mPhoneticFamilyName, _local_safe_0a1b_mPhoneticGivenName, _local_safe_0a1b_mPhoneticHonorificPrefix, _local_safe_0a1b_mPhoneticHonorificSuffix);
        }
    ...
    static void writeToParcel(Names obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(2))) {
            SafeParcelWriter.writeString(parcel, 2, obj.mDisplayName, true);
        }
        if (__setFields.contains(Integer.valueOf(3))) {
            SafeParcelWriter.writeString(parcel, 3, obj.mFamilyName, true);
        }
        if (__setFields.contains(Integer.valueOf(4))) {
            SafeParcelWriter.writeString(parcel, 4, obj.mFormatted, true);
        }
        if (__setFields.contains(Integer.valueOf(5))) {
            SafeParcelWriter.writeString(parcel, 5, obj.mGivenName, true);
        }
        if (__setFields.contains(Integer.valueOf(6))) {
            SafeParcelWriter.writeString(parcel, 6, obj.mHonorificPrefix, true);
        }
        if (__setFields.contains(Integer.valueOf(7))) {
            SafeParcelWriter.writeString(parcel, 7, obj.mHonorificSuffix, true);
        }
        if (__setFields.contains(Integer.valueOf(8))) {
            SafeParcelWriter.writeParcelable(parcel, 8, obj.mMetadata, flags, true);
        }
