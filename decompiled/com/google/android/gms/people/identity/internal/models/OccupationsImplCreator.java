...
public class OccupationsImplCreator implements Creator<OccupationsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public OccupationsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new OccupationsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public OccupationsImpl[] newArray(int size) {
        return new OccupationsImpl[size];
    }

    static void writeToParcel(OccupationsImpl obj, Parcel parcel, int flags) {
