...
public class CustomFieldsImplCreator implements Creator<CustomFieldsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public CustomFieldsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new CustomFieldsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mKey, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public CustomFieldsImpl[] newArray(int size) {
        return new CustomFieldsImpl[size];
    }

    static void writeToParcel(CustomFieldsImpl obj, Parcel parcel, int flags) {
