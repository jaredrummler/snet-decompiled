...
public class NotesImplCreator implements Creator<NotesImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public NotesImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new NotesImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
    ...
    static void writeToParcel(NotesImpl obj, Parcel parcel, int flags) {
