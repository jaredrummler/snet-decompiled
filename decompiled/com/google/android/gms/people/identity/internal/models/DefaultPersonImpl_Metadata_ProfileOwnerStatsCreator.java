...
public class DefaultPersonImpl_Metadata_ProfileOwnerStatsCreator implements Creator<ProfileOwnerStats> {
    public static final int CONTENT_DESCRIPTION = 0;

    public ProfileOwnerStats createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new ProfileOwnerStats(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mIncomingAnyCircleCount, _local_safe_0a1b_mViewCount);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public ProfileOwnerStats[] newArray(int size) {
        return new ProfileOwnerStats[size];
    }

    static void writeToParcel(ProfileOwnerStats obj, Parcel parcel, int flags) {
