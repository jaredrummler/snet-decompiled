...
public class NicknamesImplCreator implements Creator<NicknamesImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public NicknamesImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new NicknamesImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public NicknamesImpl[] newArray(int size) {
        return new NicknamesImpl[size];
    }

    static void writeToParcel(NicknamesImpl obj, Parcel parcel, int flags) {
