...
public class DefaultPersonImpl_NicknamesCreator implements Creator<Nicknames> {
    public static final int CONTENT_DESCRIPTION = 0;

    public Nicknames createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Nicknames(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public Nicknames[] newArray(int size) {
        return new Nicknames[size];
    }

    static void writeToParcel(Nicknames obj, Parcel parcel, int flags) {
