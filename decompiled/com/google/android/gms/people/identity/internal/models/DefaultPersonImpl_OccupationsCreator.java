...
public class DefaultPersonImpl_OccupationsCreator implements Creator<Occupations> {
    public static final int CONTENT_DESCRIPTION = 0;

    public Occupations createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Occupations(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
    ...
    static void writeToParcel(Occupations obj, Parcel parcel, int flags) {
