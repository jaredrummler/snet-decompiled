...
public class DefaultPersonImpl_SkillsCreator implements Creator<Skills> {
    ...
    public Skills createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Skills(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
    ...
    static void writeToParcel(Skills obj, Parcel parcel, int flags) {
