...
public class RelationshipInterestsImplCreator implements Creator<RelationshipInterestsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public RelationshipInterestsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new RelationshipInterestsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public RelationshipInterestsImpl[] newArray(int size) {
        return new RelationshipInterestsImpl[size];
    }

    static void writeToParcel(RelationshipInterestsImpl obj, Parcel parcel, int flags) {
