...
public class DefaultPersonImpl_MembershipsCreator implements Creator<Memberships> {
    ...
    public Memberships createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Memberships(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mCircle, _local_safe_0a1b_mContactGroup, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mSystemContactGroup);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public Memberships[] newArray(int size) {
        return new Memberships[size];
    }

    static void writeToParcel(Memberships obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(2))) {
            SafeParcelWriter.writeString(parcel, 2, obj.mCircle, true);
        }
        if (__setFields.contains(Integer.valueOf(3))) {
            SafeParcelWriter.writeString(parcel, 3, obj.mContactGroup, true);
        }
