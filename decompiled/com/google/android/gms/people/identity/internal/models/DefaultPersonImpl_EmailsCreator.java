...
public class DefaultPersonImpl_EmailsCreator implements Creator<Emails> {
    ...
    public Emails createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new Emails(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
    ...
    static void writeToParcel(Emails obj, Parcel parcel, int flags) {
