...
public class DefaultPersonImpl_InstantMessagingCreator implements Creator<InstantMessaging> {
    ...
    public InstantMessaging createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new InstantMessaging(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mFormattedProtocol, _local_safe_0a1b_mFormattedType, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mProtocol, _local_safe_0a1b_mType, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public InstantMessaging[] newArray(int size) {
        return new InstantMessaging[size];
    }

    static void writeToParcel(InstantMessaging obj, Parcel parcel, int flags) {
        ...
        if (__setFields.contains(Integer.valueOf(2))) {
            SafeParcelWriter.writeString(parcel, 2, obj.mFormattedProtocol, true);
        }
