...
public class GendersImplCreator implements Creator<GendersImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public GendersImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new GendersImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mFormattedValue, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public GendersImpl[] newArray(int size) {
        return new GendersImpl[size];
    }

    static void writeToParcel(GendersImpl obj, Parcel parcel, int flags) {
