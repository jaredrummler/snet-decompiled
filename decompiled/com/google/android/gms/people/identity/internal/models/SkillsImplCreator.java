...
public class SkillsImplCreator implements Creator<SkillsImpl> {
    public static final int CONTENT_DESCRIPTION = 0;

    public SkillsImpl createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new SkillsImpl(_local_safe_0a1b_mIndicatorSet, _local_safe_0a1b_mVersionCode, _local_safe_0a1b_mMetadata, _local_safe_0a1b_mValue);
        }
        throw new ParseException("Overread allowed size end=" + end, parcel);
    }

    public SkillsImpl[] newArray(int size) {
        return new SkillsImpl[size];
    }

    static void writeToParcel(SkillsImpl obj, Parcel parcel, int flags) {
