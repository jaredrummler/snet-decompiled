...
public class AuthorizationRequestCreator implements Creator<AuthorizationRequest> {
    ...
    public AuthorizationRequest createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new AuthorizationRequest(_local_safe_0a1b_mVersion, _local_safe_0a1b_mPermitId, _local_safe_0a1b_mPermitAccessId, _local_safe_0a1b_mData);
        }
    ...
    static void writeToParcel(AuthorizationRequest obj, Parcel parcel, int flags) {
