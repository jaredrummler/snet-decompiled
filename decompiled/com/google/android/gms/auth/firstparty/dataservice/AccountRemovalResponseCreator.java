...
public class AccountRemovalResponseCreator implements Creator<AccountRemovalResponse> {
    ...
    public AccountRemovalResponse createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new AccountRemovalResponse(_local_safe_0a1b_version, _local_safe_0a1b_statusWireCode);
        }
    ...
    static void writeToParcel(AccountRemovalResponse obj, Parcel parcel, int flags) {
