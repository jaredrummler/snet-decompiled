...
public class ConfirmCredentialsRequestCreator implements Creator<ConfirmCredentialsRequest> {
    ...
    public ConfirmCredentialsRequest createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new ConfirmCredentialsRequest(_local_safe_0a1b_version, _local_safe_0a1b_accountCredentials, _local_safe_0a1b_optionalCaptchaSolution);
        }
    ...
    static void writeToParcel(ConfirmCredentialsRequest obj, Parcel parcel, int flags) {
