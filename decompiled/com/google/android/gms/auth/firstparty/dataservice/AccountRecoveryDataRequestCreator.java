...
public class AccountRecoveryDataRequestCreator implements Creator<AccountRecoveryDataRequest> {
    ...
    public AccountRecoveryDataRequest createFromParcel(Parcel parcel) {
        ...
        boolean _local_safe_0a1b_isClearUpdateSuggested = false;
        AppDescription _local_safe_0a1b_callingAppDescription = null;
        String _local_safe_0a1b_requestDescription = null;
        ...
        while (parcel.dataPosition() < end) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case Type.INDEFINITELY /*2*/:
                    ...
                    break;
                case Type.CUSTOM /*3*/:
                    _local_safe_0a1b_isClearUpdateSuggested = SafeParcelReader.readBoolean(parcel, header);
                    break;
                ...
                case LocationSharingEvent.Type.ADD_NEW_SHARES /*5*/:
                    _local_safe_0a1b_requestDescription = SafeParcelReader.createString(parcel, header);
                    break;
        ...
        if (parcel.dataPosition() == end) {
            return new AccountRecoveryDataRequest(_local_safe_0a1b_version, _local_safe_0a1b_accountName, _local_safe_0a1b_isClearUpdateSuggested, _local_safe_0a1b_callingAppDescription, _local_safe_0a1b_requestDescription, _local_safe_0a1b_account);
        }
    ...
    static void writeToParcel(AccountRecoveryDataRequest obj, Parcel parcel, int flags) {
        int myStart = SafeParcelWriter.beginObjectHeader(parcel);
        SafeParcelWriter.writeInt(parcel, 1, obj.version);
        SafeParcelWriter.writeString(parcel, 2, obj.accountName, false);
        SafeParcelWriter.writeBoolean(parcel, 3, obj.isClearUpdateSuggested);
        SafeParcelWriter.writeParcelable(parcel, 4, obj.callingAppDescription, flags, false);
        SafeParcelWriter.writeString(parcel, 5, obj.requestDescription, false);
