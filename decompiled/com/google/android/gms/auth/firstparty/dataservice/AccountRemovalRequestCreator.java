...
public class AccountRemovalRequestCreator implements Creator<AccountRemovalRequest> {
    ...
    public AccountRemovalRequest createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new AccountRemovalRequest(_local_safe_0a1b_version, _local_safe_0a1b_accountName, _local_safe_0a1b_account);
        }
    ...
    static void writeToParcel(AccountRemovalRequest obj, Parcel parcel, int flags) {
