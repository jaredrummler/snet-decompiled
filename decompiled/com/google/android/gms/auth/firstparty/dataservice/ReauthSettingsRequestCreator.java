...
public class ReauthSettingsRequestCreator implements Creator<ReauthSettingsRequest> {
    ...
    public ReauthSettingsRequest createFromParcel(Parcel parcel) {
        ...
        boolean _local_safe_0a1b_force = false;
        ...
        while (parcel.dataPosition() < end) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case Type.INDEFINITELY /*2*/:
                    ...
                    break;
                case Type.CUSTOM /*3*/:
                    _local_safe_0a1b_force = SafeParcelReader.readBoolean(parcel, header);
                    break;
        ...
        if (parcel.dataPosition() == end) {
            return new ReauthSettingsRequest(_local_safe_0a1b_version, _local_safe_0a1b_accountName, _local_safe_0a1b_force, _local_safe_0a1b_account, _local_safe_0a1b_callingPackageName);
        }
    ...
    static void writeToParcel(ReauthSettingsRequest obj, Parcel parcel, int flags) {
        int myStart = SafeParcelWriter.beginObjectHeader(parcel);
        SafeParcelWriter.writeInt(parcel, 1, obj.version);
        SafeParcelWriter.writeString(parcel, 2, obj.accountName, false);
        SafeParcelWriter.writeBoolean(parcel, 3, obj.force);
