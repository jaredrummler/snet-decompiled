...
public class CheckRealNameResponseCreator implements Creator<CheckRealNameResponse> {
    ...
    public CheckRealNameResponse createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new CheckRealNameResponse(_local_safe_0a1b_version, _local_safe_0a1b_statusWireCode);
        }
    ...
    static void writeToParcel(CheckRealNameResponse obj, Parcel parcel, int flags) {
