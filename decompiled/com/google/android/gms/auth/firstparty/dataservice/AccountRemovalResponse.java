...
@Class(creator = "AccountRemovalResponseCreator")
public class AccountRemovalResponse implements SafeParcelable {
    public static final AccountRemovalResponseCreator CREATOR;
    ...
    static {
        CREATOR = new AccountRemovalResponseCreator();
    }

    @Constructor
    AccountRemovalResponse(@Param(id = 1) int version, @Param(id = 2) String statusWireCode) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        AccountRemovalResponseCreator.writeToParcel(this, dest, flags);
    }
