...
public class UpdateCredentialsWorkflowRequestCreator implements Creator<UpdateCredentialsWorkflowRequest> {
    ...
    public UpdateCredentialsWorkflowRequest createFromParcel(Parcel parcel) {
        ...
        if (parcel.dataPosition() == end) {
            return new UpdateCredentialsWorkflowRequest(_local_safe_0a1b_version, _local_safe_0a1b_accountName, _local_safe_0a1b_callingAppDescription, _local_safe_0a1b_options, _local_safe_0a1b_account, _local_safe_0a1b_amResponse);
        }
    ...
    static void writeToParcel(UpdateCredentialsWorkflowRequest obj, Parcel parcel, int flags) {
