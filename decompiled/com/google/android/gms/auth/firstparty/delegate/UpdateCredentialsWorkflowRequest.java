...
@Class(creator = "UpdateCredentialsWorkflowRequestCreator")
public class UpdateCredentialsWorkflowRequest implements SafeParcelable {
    public static final UpdateCredentialsWorkflowRequestCreator CREATOR;
    ...
    static {
        CREATOR = new UpdateCredentialsWorkflowRequestCreator();
    }

    @Constructor
    UpdateCredentialsWorkflowRequest(@Param(id = 1) int version, @Param(id = 2) String accountName, @Param(id = 3) AppDescription callingAppDescription, @Param(id = 4) Bundle options, @Param(id = 5) Account account, @Param(id = 6) AccountAuthenticatorResponse amResponse) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        UpdateCredentialsWorkflowRequestCreator.writeToParcel(this, dest, flags);
    }
