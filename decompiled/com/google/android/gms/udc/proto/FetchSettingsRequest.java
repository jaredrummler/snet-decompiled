...
public final class FetchSettingsRequest extends ExtendableMessageNano<FetchSettingsRequest> {
    private static volatile FetchSettingsRequest[] _emptyArray;
    ...
    public static FetchSettingsRequest[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new FetchSettingsRequest[0];
                }
            }
        }
        return _emptyArray;
    ...
    public FetchSettingsRequest clear() {
        this.apiHeader = null;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FetchSettingsRequest)) {
            return false;
        }
        FetchSettingsRequest other = (FetchSettingsRequest) o;
    ...
    public void writeTo(CodedOutputByteBufferNano output) throws IOException {
        ...
        if (this.fetchAll) {
            output.writeBool(2, this.fetchAll);
        }
        if (this.apiHeader != null) {
    ...
    protected int computeSerializedSize() {
        ...
        if (this.fetchAll) {
            size += CodedOutputByteBufferNano.computeBoolSize(2, this.fetchAll);
        }
        if (this.apiHeader != null) {
    ...
    public FetchSettingsRequest mergeFrom(CodedInputByteBufferNano input) throws IOException {
        while (true) {
    ...
    public static FetchSettingsRequest parseFrom(byte[] data) throws InvalidProtocolBufferNanoException {
        return (FetchSettingsRequest) MessageNano.mergeFrom(new FetchSettingsRequest(), data);
    }

    public static FetchSettingsRequest parseFrom(CodedInputByteBufferNano input) throws IOException {
        return new FetchSettingsRequest().mergeFrom(input);
    }
}
