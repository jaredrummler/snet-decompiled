...
class MediaRouterJellybean {
    ...
    public static final class RouteGroup {
        public static List getGroupedRoutes(Object groupObj) {
            ...
            for (int i = 0; i < count; i += MediaRouterJellybean.ROUTE_TYPE_LIVE_AUDIO) {
    ...
    public static final class SelectRouteWorkaround {
        ...
        public void selectRoute(Object routerObj, int types, Object routeObj) {
            ...
            if ((MediaRouterJellybean.ROUTE_TYPE_USER & route.getSupportedTypes()) == 0) {
                if (this.mSelectRouteIntMethod != null) {
                    try {
                        ...
                        objArr[0] = Integer.valueOf(types);
                        objArr[MediaRouterJellybean.ROUTE_TYPE_LIVE_AUDIO] = route;
                        method.invoke(router, objArr);
                        return;
