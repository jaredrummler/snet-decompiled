...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    public void invalidateVirtualView(int virtualViewId) {
        sendEventForVirtualView(virtualViewId, PeopleColumnBitmask.NAME_VERIFIED);
    }
    ...
    private void updateHoveredVirtualView(int virtualViewId) {
        if (this.mHoveredVirtualViewId != virtualViewId) {
            ...
            sendEventForVirtualView(virtualViewId, LogSource.KEEP);
            sendEventForVirtualView(previousVirtualViewId, PeopleColumnBitmask.IS_BLOCKED);
        }
    }
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int virtualViewId) {
        ...
        if ((actions & 64) != 0) {
        ...
        } else if ((actions & LogSource.KEEP) != 0) {
            ...
            if (this.mFocusedVirtualViewId == virtualViewId) {
                ...
                node.addAction((int) LogSource.KEEP);
            } else {
    ...
    private boolean requestAccessibilityFocus(int virtualViewId) {
        ...
        if (this.mFocusedVirtualViewId != INVALID_ID) {
            sendEventForVirtualView(this.mFocusedVirtualViewId, PeopleColumnBitmask.AFFINITY_2);
        }
        this.mFocusedVirtualViewId = virtualViewId;
        this.mView.invalidate();
        sendEventForVirtualView(virtualViewId, PeopleColumnBitmask.AFFINITY_1);
        return true;
    }
    ...
    private boolean clearAccessibilityFocus(int virtualViewId) {
        ...
        this.mFocusedVirtualViewId = INVALID_ID;
        this.mView.invalidate();
        sendEventForVirtualView(virtualViewId, PeopleColumnBitmask.AFFINITY_2);
        return true;
    }
