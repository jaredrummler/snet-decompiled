...
class BundleCompatDonut {
    ...
    L_0x0024:
        r1 = sGetIBinderMethod;	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r3 = 1;
        r3 = new java.lang.Object[r3];	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r4 = 0;
        r3[r4] = r9;	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r1 = r1.invoke(r8, r3);	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
        r1 = (android.os.IBinder) r1;	 Catch:{ InvocationTargetException -> 0x0048, IllegalAccessException -> 0x004a, IllegalArgumentException -> 0x003c }
    L_0x0032:
        return r1;
    L_0x0033:
        r0 = move-exception;
    ...
    L_0x0028:
        r1 = sPutIBinderMethod;	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r2 = 2;
        r2 = new java.lang.Object[r2];	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r3 = 0;
        r2[r3] = r8;	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r3 = 1;
        r2[r3] = r9;	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
        r1.invoke(r7, r2);	 Catch:{ InvocationTargetException -> 0x004c, IllegalAccessException -> 0x004e, IllegalArgumentException -> 0x0040 }
    L_0x0036:
        return;
    L_0x0037:
        r0 = move-exception;
